  ...
  return (
    <Routes>
      <Route element={<PublicAppShell />}>
        ...
        <Route 
          path="/sign-in" 
          element={<UnavailablePage title="Akses akun belum tersedia pada tahap ini." description="PLAN-001 tidak menyediakan login simulasi, role demo, atau autentikasi sementara." />} 
        />
