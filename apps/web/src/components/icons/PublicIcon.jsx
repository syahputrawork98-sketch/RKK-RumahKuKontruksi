...
const icons = {
  ...
  'file-check': <><path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z" /><path d="M14 2v4a1 1 0 0 0 1 1h4" /><path d="m9 15 2 2 4-4" /></>
};

export default function PublicIcon({ name, className = '', size = 24, ...props }) {
