        ...
        <div className="animate-fadeIn space-y-6 pb-20">
            ...
            <div className="dashboard-card py-24 flex flex-col items-center justify-center text-center">
                ...
                <p className="text-sm text-[var(--dashboard-text-soft)] max-w-md leading-relaxed italic mb-8">
                    Halaman ini berkaitan dengan alur manajemen desain tingkat lanjut yang membutuhkan integrasi cloud storage dan workflow eksternal. Di fase <strong>Local Development</strong>, akses ke fitur ini dibatasi untuk menjaga kestabilan database lokal.
                </p>
