        ...
        <div className="animate-fadeIn space-y-6 pb-20">
            ...
            <div className="dashboard-card py-24 flex flex-col items-center justify-center text-center">
                ...
                <p className="text-sm text-[var(--dashboard-text-soft)] max-w-md leading-relaxed italic mb-8">
                    Halaman ini berkaitan dengan manajemen teknis lapangan tingkat lanjut atau fitur marketplace proyek eksternal. 
                    Di fase <strong>Local Development</strong>, akses difokuskan pada operasional proyek aktif (Jurnal, Material, Kendala) untuk memastikan kestabilan database lokal.
                </p>
