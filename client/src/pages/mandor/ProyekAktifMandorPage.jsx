            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {projects.length > 0 ? projects.map((prj) => {
                        ...
                        <div key={prj.id} className="dashboard-card group hover:border-[var(--dashboard-primary)]/50 transition-all p-0 overflow-hidden">
                            <div className="p-5 space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs font-bold">0 Orang</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="p-3 bg-[var(--dashboard-surface-soft)] rounded-xl border border-dashed border-[var(--dashboard-border)]">
                                    ...
                                    <p className="text-xs font-bold italic text-slate-400">"Belum ada target tugas hari ini"</p>
                                </div>
                            </div>
                    ...
                    <div className="col-span-2 py-20 text-center text-slate-400 font-medium italic border-2 border-dashed border-slate-100 rounded-2xl">
                        Tidak ada proyek yang sedang Anda kerjakan.
                    </div>
                )}
            </div>
        </div>
