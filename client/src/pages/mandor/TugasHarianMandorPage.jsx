...
const TugasHarianMandorPage = () => {
    ...
    return (
        <div className="animate-fadeIn space-y-6">
                                ...
                                <div className="space-y-2">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-xs font-black text-slate-800">
                                            {task.project?.name || "Proyek Lapangan"}
                                        </span>
            ...
            {/* Progress SOT Disclaimer */}
            <div className="p-4 bg-blue-50 border border-blue-100 rounded-2xl flex gap-3 mt-6">
                ...
                <div className="text-[10px] font-medium leading-relaxed italic text-blue-800">
                    ...
                    <p>Daftar tugas ini adalah log operasional harian. Menyelesaikan tugas di sini membantu koordinasi lapangan, namun <strong>tidak secara otomatis mengubah Progres Resmi (Source of Truth)</strong> yang dikelola oleh Pengawas.</p>
                </div>
            </div>
        </div>
    );
