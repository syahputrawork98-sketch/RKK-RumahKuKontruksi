...
const STATUS_MAP = {
    ...
    resolved:  { label: "Sudah Diatasi (Resolved)",  color: "bg-emerald-50 text-emerald-600 border-emerald-200" },
    closed:    { label: "Selesai Administratif",    color: "bg-slate-50 text-slate-400 border-slate-100" },
    rejected:  { label: "Dibatalkan / Invalid",     color: "bg-rose-50 text-rose-500 border-rose-200" },
};
