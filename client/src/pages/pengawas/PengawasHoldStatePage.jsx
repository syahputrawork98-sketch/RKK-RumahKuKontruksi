        ...
        <div className="animate-fadeIn space-y-6 pb-20">
            ...
            <div className="dashboard-card py-24 flex flex-col items-center justify-center text-center">
                ...
                <p className="text-sm text-[var(--dashboard-text-soft)] max-w-md leading-relaxed italic mb-8">
                    Halaman ini berkaitan dengan manajemen detail teknis lapangan tingkat lanjut (gambar kerja, baseline RAB, atau eskalasi kendala). Di fase <strong>Local Development</strong>, akses difokuskan pada Verifikasi Progres dan Laporan Mingguan untuk memastikan stabilitas data SOT.
                </p>
