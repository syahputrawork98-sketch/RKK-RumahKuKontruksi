...
const PengawasHoldStatePage = ({ title, description }) => {
    return (
        <div className="animate-fadeIn space-y-6 pb-20">
            ...
            <div className="dashboard-card py-24 flex flex-col items-center justify-center text-center">
                ...
                <h2 className="text-xl font-black text-[var(--dashboard-text)] mb-3">Modul Pengawasan Teknis Ditangguhkan</h2>
                <p className="text-sm text-[var(--dashboard-text-soft)] max-w-md leading-relaxed italic mb-8">
                    Halaman ini berkaitan dengan manajemen detail teknis lapangan tingkat lanjut (manajemen file gambar kerja, verifikasi RAB baseline, atau pelaporan kendala eskalatif). Di fase <strong>Local Development CRUD Integration</strong>, akses difokuskan pada Verifikasi Progres dan Laporan Mingguan.
                </p>
                ...
                <div className="flex flex-col items-center gap-4">
                    <div className="px-6 py-3 bg-[var(--dashboard-primary)] text-white rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-xl shadow-[var(--dashboard-primary)]/20">
                        Menunggu Integrasi Technical Engine v2
                    </div>
                    <p className="text-[10px] text-slate-400 font-bold uppercase tracking-tighter">
                        Status: Quality Assurance Queue
                    </p>
                </div>
            </div>
            ...
            <div className="p-6 bg-[var(--dashboard-primary-soft)] border border-[var(--dashboard-primary)]/10 rounded-2xl flex gap-4 items-start">
                ...
                <div>
                    <p className="text-xs font-bold text-[var(--dashboard-primary)] mb-1 uppercase tracking-tight">Informasi Pengawas</p>
                    <p className="text-xs text-[var(--dashboard-primary)]/80 leading-relaxed font-medium">
                        Fitur ini dijadwalkan aktif setelah alur sinkronisasi Jurnal Mandor dan Laporan Mingguan dinyatakan stabil. Silakan gunakan menu <strong>Verifikasi Progres</strong> dan <strong>Laporan Mingguan</strong> untuk tugas pengawasan utama.
                    </p>
                </div>
            </div>
        </div>
...
export default PengawasHoldStatePage;
