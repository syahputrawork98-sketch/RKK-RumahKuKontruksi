  ...
  return (
    <div className="animate-fadeIn">
      <div className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          <h1 className="dashboard-title text-4xl font-black text-[var(--dashboard-text)]">Direktori Persona Pengawas</h1>
          <p className="dashboard-subtitle text-lg italic">Manajemen direktori persona lokal untuk role Pengawas. Superadmin mengelola entitas database ini untuk simulasi operasional di localhost.</p>
        </div>
