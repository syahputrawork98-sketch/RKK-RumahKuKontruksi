...
- **Operational Status**: 
  ...
  - Post-Completion Guard: **Local Workflow v1 / Stabilized**. Setelah project selesai lokal, Pengawas tetap bisa membaca histori project/laporan, tetapi action lapangan baru ditahan.
...
- **Operational Status**: 
  ...
  - Post-Completion Guard: **Local Workflow v1 / Stabilized**. Setelah project selesai lokal, Mandor tetap bisa membaca histori project/jurnal/material request, tetapi action lapangan baru ditahan.
...
- **Operational Data**: 
  ...
  - Project selesai: **Reader/Status Local Workflow v1 / Stabilized**. Admin dapat membaca status selesai lokal; closeout tidak mengubah `Project.verifiedProgress` dan bukan BAST/legal handover, invoice/payment/escrow, atau sertifikat resmi.
